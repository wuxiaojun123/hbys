...
import com.reward.help.merchant.chat.runtimepermissions.PermissionsManager;
import com.reward.help.merchant.chat.runtimepermissions.PermissionsResultAction;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
	...
	RadioButton radio_group;//商家群
	@BindView(R.id.radio_mine)
	RadioButton radio_mine;//我的
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragments = new Fragment[] { conversationListFragment, contactListFragment, mineFragment};

		getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, conversationListFragment)
				.add(R.id.fragment_container, contactListFragment).hide(contactListFragment).show(conversationListFragment)
				.commit();
		radio_chat.performClick();
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
	...
	@OnClick({R.id.radio_chat,R.id.radio_group,R.id.radio_mine})
	@Override
