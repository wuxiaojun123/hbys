package com.reward.help.merchant.chat.nickNameAndHead;
...
public class SqliteHelper extends OrmLiteSqliteOpenHelper {
    ...
    // 数据库名字
    private static final String DATABASE_NAME = "im_seller_cache.db";
    ...
    public synchronized static SqliteHelper getInstance(){
        if (mInstance == null) {
            mInstance = new SqliteHelper(App.getApplication());
        }
