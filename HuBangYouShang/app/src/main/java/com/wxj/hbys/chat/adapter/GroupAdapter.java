 ...
 */
package com.wxj.hbys.chat.adapter;
...
import com.wxj.hbys.adapter.BaseRecyclerAdapter;
...
public class GroupAdapter extends RecyclerView.Adapter<SuperViewHolder> {
    //为了区分加入标签
    ...
    public GroupAdapter(Context context, int newGroup, int addPublicGroup) {
    ...
    public void onBindViewHolder(SuperViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            ...
            default:
                ...
                mName.setText(mDataList.get(position - 1).getGroupName());
                break;
        }
    }
