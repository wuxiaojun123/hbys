...
public class PwdPaymentActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void initView() {
        tv_title.setText(R.string.string_pwd_payment_title);
                    ...
                    public void onNext(BaseResponse<String> response) {
                        if (response.code == 200) {
                            if (response.data != null) {
                                Intent mIntent = new Intent(PwdPaymentActivity.this, ResetPwdActivity.class);
                                mIntent.putExtra("phone", phoneNumber);
                                mIntent.putExtra("flag", 4);
                                startActivityForResult(mIntent, REQUEST_CODE);
                                ActivitySlideAnim.slideInAnim(PwdPaymentActivity.this);
                            }
                        } else {
