 ...
 * 给赏分
 */
public class HelpSeekInfoGivePointsDialog {

    public static void showDialog(final Activity context, final String comment_id) {
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.checkStr(points) && Integer.parseInt(points) > 0) {
                    setFavorites(context, dialog, comment_id, points);
                } else {
     ...
     * @param mContext
     */
    private static void setFavorites(final Activity mContext, final Dialog dialog, String comment_id, String points) {
        MyProcessDialog.showDialog(mContext);
        HelpNetwork
                .getHelpApi()
                .getGivePointsBean(App.APP_CLIENT_KEY, "give_points", comment_id, points)
                ...
                .subscribe(new BaseSubscriber<StringResponse>() {
                    ...
                    public void onNext(StringResponse response) {
                        ...
                        if (response.code == 200) {
                            dialog.dismiss();
                            DialogUtil.showConfirmCancleDialog(mContext, "系统提示", "您的赏分已给出", "", "确定", null);
                        } else {
