...
public class EaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    private List<EMConversation> topList;
    ...
    public EaseConversationAdapter(Context context, int resource, List<EMConversation> conversationList, List<EMConversation> topList, Map<String, TopUser> topUserMap) {
        super(context, resource, conversationList);
        mContext = context;
        this.conversationList = conversationList;
        this.topList = topList;
        this.topUserMap = topUserMap;

        copyConversationList = new ArrayList<EMConversation>();
        copyConversationList.addAll(topList);
    ...
    @Override
    public int getCount() {
        return conversationList.size() + topList.size();
    }

    @Override
    public EMConversation getItem(int arg0) {
        if (arg0 < topList.size()) {
            return topList.get(arg0);
        } else {
            return conversationList.get(arg0 - topList.size());
        }
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.ease_row_chat_history, parent, false);
        }
