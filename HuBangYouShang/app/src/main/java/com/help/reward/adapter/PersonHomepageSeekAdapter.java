...
public class PersonHomepageSeekAdapter extends BaseRecyclerAdapter<HomepageBean> {

    public PersonHomepageSeekAdapter(Context context) {
        super(context);
    }
    ...
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        HomepageBean item =mDataList.get(position);
        ...
        item_help1_score.setText("获赏 " + item.admiration);
        ...
        item_help1_des.setVisibility(View.GONE);
