...
public class EaseConversationListFragment extends EaseBaseFragment{
    ...
    protected Map<String, TopUser> topUserMap;
    protected List<EMConversation> topList = new ArrayList<>();
    ...
    protected void setUpView() {
        ...
        conversationListView.init(conversationList,topList,topUserMap);
...
//
    ...
    private void sortConversationByLastChatTimes(List<EMConversation> topList) {
        Collections.sort(topList, new Comparator<EMConversation>() {
            @Override
            public int compare(EMConversation o1, EMConversation o2) {
                EMMessage con2LastMessage = o2.getLastMessage();
                EMMessage con1LastMessage = o1.getLastMessage();
