...
public class LoadingFooter extends RelativeLayout implements ILoadMoreFooter{
    ...
    public void init(Context context) {
        ...
        indicatorColor = getContext().getResources().getColor(R.color.colorAccent);
    ...
    public void setState(State status, boolean showView) {
        ...
        switch (status) {
            ...
            case Loading:
                ...
                mLoadingText.setTextColor(getContext().getResources().getColor(hintColor));
            ...
            case NoMore:
                ...
                mNoMoreText.setTextColor(getContext().getResources().getColor(hintColor));
                break;
            case NetWorkError:
                ...
                mNoNetWorkText.setTextColor(getContext().getResources().getColor(hintColor));
                break;
            default:
                break;
        }
